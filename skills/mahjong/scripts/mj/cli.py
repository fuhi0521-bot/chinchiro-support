...
def build_parser() -> argparse.ArgumentParser:
    ...
    s.add_argument("--lineup", default="named", choices=["named", "awareness", "reading", "reading-push", "honitsu", "honitsu-field", "shape", "kaname", "wall", "fold", "riichi", "confirm", "dama", "five", "six"],
